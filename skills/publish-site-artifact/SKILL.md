...
3. Never touch `CNAME`, `.nojekyll`, `robots.txt`, `llms.txt`, `add-skill.sh`, `skills/`, `research/index.html`, `learning/index.html`, `worklog/index.html` (listings regenerate automatically via a GitHub Action). Never commit tokens/secrets.
